...
namespace Migrations.Migrations
{
    ...
    [Migration("20260915152945_AddFreezeInvalidation")]
    partial class AddFreezeInvalidation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Backend.Domain.Entities.Application", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("App.Backend.Domain.Entities.Events.Event", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("App.Backend.Domain.Entities.Events.EventFeedback", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("tbl_event_feedback");
                });

            modelBuilder.Entity("App.Backend.Domain.Entities.Freeze", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("tbl_freeze");
                });

            modelBuilder.Entity("App.Backend.Domain.Entities.GitInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("App.Backend.Domain.Entities.Kickoff", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("App.Backend.Domain.Entities.Reviews.Annotation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("App.Backend.Domain.Entities.System", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("App.Backend.Domain.Relations.CursusGoal", b =>
                {
                    b.Property<Guid>("CursusId")
                        .HasColumnType("uuid")
                        .HasColumnName("cursus_id");
                    ...
                    b.HasKey("CursusId", "GoalId");

                    b.HasIndex("GoalId");

                    b.HasIndex("CursusId", "ParentGoalId");

                    b.ToTable("rel_cursus_goal");
                });
            ...
            modelBuilder.Entity("App.Backend.Domain.Relations.UserEvent", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id")
                    ...
                    b.ToTable("rel_user_event");
                });

            modelBuilder.Entity("App.Backend.Domain.Relations.UserKickoff", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id")
                    ...
                    b.Property<Guid>("KickoffId")
                        .HasColumnType("uuid")
                        .HasColumnName("kickoff_id")
                        .HasColumnOrder(0);
                    ...
                    b.HasKey("UserId", "KickoffId");

                    b.HasIndex("KickoffId");

                    b.ToTable("rel_user_kickoff");
                });
            ...
            modelBuilder.Entity("App.Backend.Domain.Entities.Events.EventFeedback", b =>
                {
                    b.HasOne("App.Backend.Domain.Entities.Events.Event", "Event")
                        .WithMany("Feedback")
            ...
            modelBuilder.Entity("App.Backend.Domain.Entities.Member", b =>
                {
                    b.HasOne("App.Backend.Domain.Entities.GitInfo", "Git")
                        .WithMany()
                        .HasForeignKey("GitId");
            ...
            modelBuilder.Entity("App.Backend.Domain.Entities.Reviews.Annotation", b =>
                {
                    b.HasOne("App.Backend.Domain.Entities.Users.User", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("App.Backend.Domain.Entities.Reviews.Review", "Review")
            ...
            modelBuilder.Entity("App.Backend.Domain.Entities.Reviews.Rubric", b =>
                {
                    b.HasOne("App.Backend.Domain.Entities.GitInfo", "GitInfo")
                        .WithMany("Rubrics")
            ...
            modelBuilder.Entity("App.Backend.Domain.Relations.UserKickoff", b =>
                {
                    b.HasOne("App.Backend.Domain.Entities.Kickoff", "Kickoff")
                        .WithMany()
