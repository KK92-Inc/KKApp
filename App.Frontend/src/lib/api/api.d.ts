...
export interface paths {
    ...
    "/account/notifications/read": {
        ...
        post: {
            parameters: {
                query?: {
                    /** @description Whether to mark them as read, defaults to true */
                    "mark[read]"?: boolean;
                };
                header?: never;
                path?: never;
    ...
    "/events": {
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "text/plain": components["schemas"]["EventDO"][];
                        "application/json": components["schemas"]["EventDO"][];
                        "text/json": components["schemas"]["EventDO"][];
                    };
                };
                /** @description Unauthorized */
                401: {
        ...
        /**
         * Create a new event
         * @description Creates a new campus event created by the requesting user
         */
        post: {
            parameters: {
                query?: never;
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["PostEventRequestDTO"];
                    "text/json": components["schemas"]["PostEventRequestDTO"];
                    "application/*+json": components["schemas"]["PostEventRequestDTO"];
                };
            };
            responses: {
    ...
    "/events/{id}": {
        ...
        post?: never;
        /**
         * Reject/Cancel an event
         * @description Reject/Cancel an existing event by ID
         */
        delete: {
            parameters: {
                query?: never;
         ...
         * @description Updates provided fields for an existing event by ID
         */
        patch: {
            parameters: {
                query?: never;
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["PatchEventRequestDTO"];
                    "text/json": components["schemas"]["PatchEventRequestDTO"];
                    "application/*+json": components["schemas"]["PatchEventRequestDTO"];
                };
            };
            responses: {
    ...
    "/events/{id}/feedback": {
        ...
        /**
         * Query event feedback
         * @description Retrieve a paginated list of feedback for a specific event
         */
        get: {
            parameters: {
                query?: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "text/plain": components["schemas"]["EventFeedbackDO"][];
                        "application/json": components["schemas"]["EventFeedbackDO"][];
                        "text/json": components["schemas"]["EventFeedbackDO"][];
                    };
                };
                /** @description Unauthorized */
                401: {
         ...
         * @description Submits a rating and comment for a specific event
         */
        post: {
            parameters: {
                query?: never;
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["PostEventFeedbackRequestDTO"];
                    "text/json": components["schemas"]["PostEventFeedbackRequestDTO"];
                    "application/*+json": components["schemas"]["PostEventFeedbackRequestDTO"];
                };
            };
            responses: {
    ...
    "/events/{id}/leave": {
        ...
        /**
         * Leave an event
         * @description Unregisters the authenticated user from an event
         */
        post: {
            parameters: {
                query?: never;
    ...
    "/system": {
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["SystemInitDTO"];
                    "text/json": components["schemas"]["SystemInitDTO"];
                    "application/*+json": components["schemas"]["SystemInitDTO"];
                };
            };
            responses: {
    ...
    "/projects/{id}/undeprecate": {
        ...
        put?: never;
        /**
         * Undeprecate a project
         * @description Restore a project by setting deprecated to false
         */
        post: {
            parameters: {
                query?: never;
    ...
    "/users": {
        ...
        /**
         * Create a user
         * @description Provision a new user and create a Keycloak account for them.
         */
        post: {
            parameters: {
                query?: {
    ...
    "/users/eligible": {
         ...
         * @description Retrieve a paginated list of all users who are elligible for a certain entity.
    ...
    "/freeze": {
        ...
        /**
         * Get currently frozen users
         * @description Retrieve a paginated list of users who are currently frozen
         */
        get: {
            parameters: {
                query?: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "text/plain": components["schemas"]["FreezeDO"][];
                        "application/json": components["schemas"]["FreezeDO"][];
                        "text/json": components["schemas"]["FreezeDO"][];
                    };
                };
                /** @description Unauthorized */
                401: {
    ...
    "/users/{userId}/freeze": {
        ...
        /**
         * Get a user's freeze
         * @description Retrieve the freeze record for a user
         */
        get: {
            parameters: {
                query?: never;
        ...
        /**
         * Freeze a user
         * @description Freeze a user account and return the created freeze record
         */
        post: {
            parameters: {
                query?: never;
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["PostUserFreezeRequestDTO"];
                    "text/json": components["schemas"]["PostUserFreezeRequestDTO"];
                    "application/*+json": components["schemas"]["PostUserFreezeRequestDTO"];
                };
            };
            responses: {
    ...
    "/users/{userId}/anonymize": {
        ...
        /**
         * Anonymize a user
         * @description Anonymize a user account and remove its personal SSH keys
         */
        post: {
            parameters: {
                query?: never;
    ...
    "/user-projects/{id}/invite/{userId}": {
         ...
         * @description The calling user (leader or staff) invites another user to their active project session.
         */
        post: {
            parameters: {
                query?: never;
         ...
         * @description The session leader or staff cancels a pending invitation before it is accepted.
         */
        delete: {
            parameters: {
                query?: never;
    ...
    "/user-projects/{id}/member/kick/{memberId}": {
         ...
         * @description Remove a member from a project session. Requires Leader role or staff authorization.
         */
        post: {
            parameters: {
                query?: never;
    ...
    "/workspace/user/{id}": {
         ...
         * @description Retrieves the workspace of a user
         */
        get: {
            parameters: {
                query?: never;
...
export interface components {
    schemas: {
        ...
        EventDO: {
            ...
            /** Format: uuid */
            userId: string;
            participants: components["schemas"]["UserLightDO"][];
        };
        EventFeedbackDO: {
            /** Format: uuid */
            id: string;
            ...
            comment: components["schemas"]["CommentDO"];
        };
        /** @enum {unknown} */
        EventState: "Pending" | "Accepted" | "Rejected" | "Finished";
        FreezeDO: {
            /** Format: uuid */
            id: string;
            /** Format: date-time */
