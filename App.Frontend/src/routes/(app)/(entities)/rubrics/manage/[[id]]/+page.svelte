<script lang="ts">
	...
	import PageProjectSelect from './page-project-select.svelte';
	import PageVariantSelect from './page-variant-select.svelte';
			...
			<Card.Root class="mt-4 gap-1 overflow-hidden p-0">
				...
				<Card.Content class="p-4">
					<Field.Set class="gap-1.5">
						...
						<Field.Field>
							<Field.Label for="workspace">Target Project</Field.Label>
							<PageProjectSelect />
							<Field.Description>Specify what project this rubric is for.</Field.Description>
							<Field.Error errors={context.errors.projectId} />
						</Field.Field>
					</Field.Set>
				</Card.Content>
			</Card.Root>
