...
{#if activeId}
  ...
  {/if}
{:else}
  <div class="p-8 border-2 border-dashed rounded-lg flex flex-col items-center justify-center text-center">
    <p class="text-sm text-muted-foreground">
      No git repository found for this {context.view === 'assignment' ? 'assignment' : 'project'}.
    </p>
