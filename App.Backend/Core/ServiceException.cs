...
public class ServiceException : Exception
{
    ...
    public static void ThrowIf([DoesNotReturnIf(true)] bool argument, string message)
    {
    ...
    /// <param name="message">The message for the thrown exception.</param>
    /// <exception cref="ServiceException">Thrown when <paramref name="argument"/> is <c>true</c>.</exception>
    public static void ThrowIf([DoesNotReturnIf(true)] bool argument, int statusCode, string message)
    {
