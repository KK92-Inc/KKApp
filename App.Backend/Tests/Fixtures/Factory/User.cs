...
public static class UserFactory
{
    ...
    public static Faker<Details> CreateDetails(Guid? userId = null) => new Faker<Details>()
        ...
        .RuleFor(d => d.EnabledNotifications, f => NotificationMeta.Welcome | NotificationMeta.Project | NotificationMeta.Goal | NotificationMeta.Cursus | NotificationMeta.Review)
